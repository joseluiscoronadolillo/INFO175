...
def crear_bd(db_name):
    ...
    c.execute("""INSERT INTO ventas VALUES(5, "11/07/2013", "Efectivo", "Jeans Efesis", 20000, 3800, 23800, 1, "17068451-6")""")
    c.execute("""INSERT INTO ventas VALUES(6, "12/07/2013", "Débito", "Polera Sybilla", 23000, 4370, 27370, 1, "17585114-3")""")
    c.execute("""INSERT INTO ventas VALUES(7, "13/07/2013", "Efectivo", "Zapatillas Converse", 20000, 3800, 23800, 1, "16806320-2")""")
    c.execute("""INSERT INTO ventas VALUES(8, "14/07/2013", "Crédito", "Zapatillas All Stars", 30000, 5700, 35700, 1, "17693283-k")""")
    c.execute("""INSERT INTO ventas VALUES(9, "15/07/2013", "Crédito", "Pantalon Cotele Ellus", 23000, 4370, 27370, 1, "17585114-3")""")
    c.execute("""INSERT INTO ventas VALUES(10, "16/07/2013", "Efectivo", "Jeans Lewis", 24000, 4560, 28560, 1, "16806320-2")""")
    c.execute("""INSERT INTO ventas VALUES(11, "08/07/2013", "Débito", "Zapatillas Nike", 26000, 4940, 30940, 1, "17585114-3")""")
    c.execute("""INSERT INTO ventas VALUES(12, "07/07/2013", "Débito", "Blusa Sybilla", 23000, 4370, 27370, 1, "17693283-k")""")
    c.execute("""INSERT INTO ventas VALUES(13, "06/07/2013", "Cheque", "Jeans Lee", 22000, 4180, 26180, 1, "16806320-2")""")
    c.execute("""INSERT INTO ventas VALUES(14, "05/07/2013", "Cheque", "Jeans Fioriucci", 27000, 5130, 32130, 1, "17125455-8")""")
